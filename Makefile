...
LDFLAGS = 
LIBS = -lm  -lbsd -lnsl -ldl
GC_LIBS = -lgc
EXT_LIBS = -L. -lindep  $(GC_LIBS)
W3M_LIBS =  -L./libwc -lwc -lssl -lcrypto  -lssl -lcrypto -lgpm -ltinfo
...
IMGLDFLAGS = -lX11 -lgdk_pixbuf_xlib-2.0 -lgdk_pixbuf-2.0 -lgobject-2.0 -lglib-2.0  -lgdk_pixbuf-2.0 -lgobject-2.0 -lglib-2.0  
